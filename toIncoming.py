...
for i in range(0, row):
    ...
    try:
        driver.implicitly_wait(15)
        status = driver.find_element(By.XPATH,'//*[@id="device-feeder-change-status"]/option[1]')
        status.click()
        ...
        driver.implicitly_wait(15)
        driver.find_element(By.CSS_SELECTOR, 'body > div.sweet-alert.showSweetAlert.visible > div.sa-button-container > div > button').is_displayed()
...
log.write("========Updated to Incoming "+waktu+"========\n")
log.close()
